...
class MoveAbelArms(object):
    def __init__(self):   
        ...
        self._dict_gesture= {
            ...
            "hug" :             [1.9, 0.85, -0.3, -0.08, 0.556, -1.42, -0.77, 0.35, 0.53, -0.5],
            ...
            "anger": [0.997, 1.17, -2.298, -0.867, 0.299, -0.655, -1.249, 2.568, -2.821],
    ...
    def gesture_arms_list(self):
        rospy.loginfo("Gesture available: [neutral, neutral_high, zero, mano, hug, hello, sequence_test, box, box2, box3]")
