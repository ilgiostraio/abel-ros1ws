...
def gesture_arms_callback(data):
	...
	correct_string = data.data.strip()
	arms.run_gesture(correct_string, 1)
...
def moveit_callback(data):
        ...
        new_position = [pos[0], pos[1], pos[2], pos[3], pos[4], pos[5], pos[6], pos[7], pos[8], pos[9]]
