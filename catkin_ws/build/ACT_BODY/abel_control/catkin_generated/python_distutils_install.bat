...
cd "C:/ros1ws/catkin_ws/src/ACT_BODY/abel_control"
...
"C:/opt/ros/noetic/x64/python.exe" ^
    "C:/ros1ws/catkin_ws/src/ACT_BODY/abel_control\setup.py" ^
    build --build-base "C:/ros1ws/catkin_ws/build/ACT_BODY/abel_control" ^
    install %DESTDIR_ARG%  ^
